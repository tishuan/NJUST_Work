...
HD_PWD='C:/Users/PrimeBo/Desktop/Files/GRADE 3.1/Computer Organization/Experiments/RAM/RAM/RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_display.tcl

...
HD_PWD='C:/Users/PrimeBo/Desktop/Files/GRADE 3.1/Computer Organization/Experiments/RAM/RAM/RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_display.tcl -notrace
